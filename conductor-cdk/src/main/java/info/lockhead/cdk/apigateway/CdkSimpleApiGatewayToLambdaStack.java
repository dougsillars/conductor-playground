...
public class CdkSimpleApiGatewayToLambdaStack extends Stack {
	...
	public CdkSimpleApiGatewayToLambdaStack(final Construct scope, final String id, final StackProps props) {
		...
		RestApi api = RestApi.Builder.create(this, "Conductor-API").restApiName("Example CDK provided API endpoint for Conductor")
		...
		Function accountFunction = new Function(this, "ConductorExampleLambdaFunction",
		...
		Function additionalAccountFunction = new Function(this, "ConductorAdditionalExampleLambdaFunction",
	...
	private Table initCdkExampleTable() {
		...
		tableProps2 = TableProps.builder().tableName("CONDUCTOR_CDK_EXAMPLE_TABLE").partitionKey(partitionKey)
				.removalPolicy(RemovalPolicy.DESTROY).billingMode(BillingMode.PAY_PER_REQUEST).build();
		Table researchTable = new Table(this, "CONDUCTOR_CDK_EXAMPLE_TABLE", tableProps2);
